 ...
 */
public class LightSensorService extends AbstractSensorService<LightSensorValue> {
    ...
    protected LightSensorService(String uriPath, LightSensorValue initialStatus, ScheduledExecutorService executor) {
    ...
    protected void setLightValue(LightSensorValue sensorValue){
